...
def case_study_generator(to_execute, scenarios, version_name, sep, path_to_save_experiment,
    ...
    if mode == "results" or mode == "both":
        ...
        experiments_results_collectors(scenarios, sep, version_name, experiment_name + "_metadata", gui_component_class,
                                       quantity_difference, "decision_tree.log", "media" + sep, drop, path_to_save_experiment, experiment_name)

def interactive_terminal(gui_component_class, quantity_difference, scenarios, drop):
    version_name = input(
